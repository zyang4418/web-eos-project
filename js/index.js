...
const technologyDetails = {
    ...
    lighthouse: {
        ...
        content: `
            <p>Although the code does not explicitly reference Google Lighthouse APIs, the project demonstrates a number of development practices that align with Lighthouse evaluation criteria. For example, CSS variables consolidate theme colors and prevent repetitive declarations, improving maintainability and reducing stylesheet size. Animated UI components use GPU-friendly transforms (transform rather than top/left) to maintain smooth rendering performance, as seen in the floating elements and button hover animations.</p>
